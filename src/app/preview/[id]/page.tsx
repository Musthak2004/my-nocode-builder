    ...
    return (
      <div className="flex items-center justify-center min-h-dvh bg-surface">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-foreground-secondary text-lg font-medium">Project not found</p>
          <p className="text-foreground-tertiary text-sm mt-1">The project you&apos;re looking for doesn&apos;t exist or has been deleted.</p>
        </div>
      </div>
    )
  }
